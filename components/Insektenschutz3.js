				...
				<Col lg={8} className="mx-auto my-2">
					<Card className="border-0 bg-transparent text-white ">
						<Card.Body>
							...
							<h1>
								Insektenspannrahmen bieten effektiven Schutz vor Insekten und
								ermöglichen gleichzeitig eine optimale Belüftung der Wohnräume.
							</h1>
						</Card.Body>
					</Card>
				</Col>
...
export default Insektenschutz3;
